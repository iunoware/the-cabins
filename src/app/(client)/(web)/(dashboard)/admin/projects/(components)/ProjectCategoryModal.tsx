...
export default function ProjectCategoryModal({
  ...
  return (
    <div className="fixed inset-0 z-9999 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-lg overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-xl ">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 p-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <label className="flex cursor-pointer items-center justify-between rounded-xl border border-gray-100 bg-gray-50 p-3.5  ">
                <span className="text-xs font-bold text-gray-900 ">Published</span>
                <input
                  type="radio"
                  checked={isActive}
              ...
              <label className="flex cursor-pointer items-center justify-between rounded-xl border border-gray-100 bg-gray-50 p-3.5  ">
                <span className="text-xs font-bold text-gray-900 ">Draft</span>
                <input
                  type="radio"
                  checked={!isActive}
          ...
          <div className="mt-4 flex justify-end gap-3 border-t border-gray-100 pt-4 ">
            <button
              type="button"
              onClick={onClose}
              className="rounded-xl border border-gray-200 bg-white px-4.5 py-2.5 text-xs font-bold text-gray-700 transition hover:bg-gray-50"
            >
              Cancel
            </button>
